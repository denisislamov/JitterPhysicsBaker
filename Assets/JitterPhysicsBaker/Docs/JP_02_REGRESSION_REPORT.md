...
- Для публикации JP-02 версия пакета поднята с `0.0.6` до `0.0.7`.
- Интеграционная регрессия в EFT/NPI не входит в пакетный релиз и должна выполняться отдельно после обновления зависимости.
